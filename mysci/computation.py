...
def compute_windchill(t, v):
    ...
    Note: This computation is valid only for temps btwn -45F and +45F and
       wind speeds btween 3 mph and 60 mph.
...
def compute_heatindex(t, hum):
    """
    Compute heat index given the temperature and the humidity
...
def compute_dewpoint(t, h):
    ...
    tempC = (t - 32) * 5 / 9 # Convert temp from deg F to deg C
    rh = h / 100
